...
| FR-005 | Create `BacktrackingDetector` class in `src/factory/backtracking_detector.py` with `detect(returns tuple[str, list[int], str]` | High | `python -c "from src.factory.backtracking_detector import BacktrackingDetector; print('OK')"` |
