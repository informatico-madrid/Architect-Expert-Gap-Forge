...
- **FR-002**: El sistema DEBE crear un SamplingProfile dataclass con los campos: temperature, top_k, min_p, repetition_penalty, presence_penalty (opcional).
- **FR-003**: El sistema DEBE iterar a través de las siguientes dimensiones de parámetros:
...
- **FR-006**: El sistema DEBE calcular el Composite Score usando los pesos estándar: ha_modernity (0.30), reasoning_depth (0.25), functionality (0.25), completeness (0.12), style (0.08).
...
- **SC-001**: El sistema completa todas las iteraciones de calibración (mínimo 5 prompts × 27 combinaciones = 135 ejecuciones) en un tiempo razonable sin errores fatales.
...
- **SC-005**: El perfil ganador maximiza Reasoning Depth y Functional Accuracy según las puntuaciones del Judge, sin causar alucinaciones detectables.
