...
with tempfile.TemporaryDirectory() as tmp:
    ...
    # Also create a tests directory in the repo root to be found by processor
    (owner_dir / "tests").mkdir(exist_ok=True)
    ...
    # Discover modules - do NOT ignore tests so they're discovered as context
