...
def reset_all_caches() -> Dict[str, bool]:
    ...
    try:
        ...
        results['scorecard_domain_patterns_cache'] = False
        print(f"Warning: Failed to reset scorecard_domain_patterns_cache: {e}", file=sys.stderr)
    ...
    try:
        ...
        results['model_evaluator_domain_patterns_cache'] = False
        print(f"Warning: Failed to reset model_evaluator_domain_patterns_cache: {e}", file=sys.stderr)
    ...
    try:
        ...
        results['model_evaluator_prompt_mgr'] = False
        print(f"Warning: Failed to reset model_evaluator_prompt_mgr: {e}", file=sys.stderr)
