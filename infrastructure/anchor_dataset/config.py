...
class AnchorsConfig:
    ...
    def __post_init__(self) -> None:
        ...
        if os.environ.get("ANCHORS_TOTAL_SAMPLES"):
            object.__setattr__(self, "total_samples", int(os.environ["ANCHORS_TOTAL_SAMPLES"]))
        ...
        if os.environ.get("ANCHORS_TEMPERATURE"):
            object.__setattr__(self, "temperature", float(os.environ["ANCHORS_TEMPERATURE"]))
        if os.environ.get("ANCHORS_MAX_TOKENS"):
            object.__setattr__(self, "max_tokens", int(os.environ["ANCHORS_MAX_TOKENS"]))
