...
class TestServiceCallExtractor:
    ...
    def test_detects_simple_callservice(
    ...
    def test_extracts_domain_and_service(
        self, extractor: ServiceCallExtractor
    ) -> None:
    ...
    def test_extracts_single_entity_id(
        self, extractor: ServiceCallExtractor
    ) -> None:
    ...
    def test_detects_plain_hass_prefix(
        self, extractor: ServiceCallExtractor
    ) -> None:
    ...
    def test_detects_this_hass_prefix(
        self, extractor: ServiceCallExtractor
    ) -> None:
    ...
    def test_mixed_hass_prefixes_in_file(
        self, extractor: ServiceCallExtractor
    ) -> None:
...
hass.callService('cover', 'open_cover');
    ...
    def test_file_path_stored_in_token(
        self, extractor: ServiceCallExtractor
    ) -> None:
    ...
    def test_extractor_has_name_property(
        self, extractor: ServiceCallExtractor
    ) -> None:
