...
All source code in the Architect-Expert-Gap-Forge (AEGF) project is licensed under the **Apache License 2.0**. See [LICENSE](LICENSE) for the full text.
...
**If you use AEGF datasets for large language model fine-tuning or training, attribution to this project and its creator is required in your model's training documentation.**

The synthetic training data generated by AEGF includes:
- High-fidelity trajectories synthesized using Qwen3-Thinking reasoning models
- API deltas and architectural knowledge curated from production code repositories
- Domain-specific examples validated against Home Assistant (2024-2026) specifications
...
created by Joao Maria Arranz Aparicio.
```
