    ...
    try:
        ...
        if filename.endswith(".py"):
            ...
            if "test_" in filename:
                ...
                if not (content.strip().startswith("def ") or content.strip().startswith("@") or content.strip().startswith("class ")):
...
def main():
    ...
    print(f"🆗 Fragmentos Válidos: {stats['valid_fragments']} (Código válido, faltan imports)")
